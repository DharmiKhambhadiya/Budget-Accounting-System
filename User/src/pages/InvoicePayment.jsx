...
const InvoicePayment = () => {
  ...
  useEffect(() => {
    ...
    if (found) {
      // Create a copy of invoice for local state (NOT mutating original)
      setInvoice({ ...found });
    }
  }, [invoiceId]);
  ...
  const handlePayNow = async () => {
    ...
    // Simulate payment processing delay only
    await new Promise((resolve) => setTimeout(resolve, 1500));

    // Update local invoice state to reflect payment
    const updatedInvoice = {
      ...invoice,
      status: "Paid",
      payments: {
        ...invoice.payments,
        bank: invoice.amount, // Mark full amount as paid
      },
    };
